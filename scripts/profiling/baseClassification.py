...
i4train=np.vstack((trainFeatures_files,trainFeatures_browsing,trainFeatures_images,trainFeatures_streaming))
i5Ctest=np.vstack((testFeatures_files,testFeatures_browsing,testFeatures_images,testFeatures_streaming))

print("Training SVMs with Linear")
svc = svm.SVC(kernel='linear').fit(i4train, o4trainClass)  
print("Training SVMs with RBF")
rbf_svc = svm.SVC(kernel='rbf').fit(i4train, o4trainClass)  
print("Training SVMs with Poly")
poly_svc = svm.SVC(kernel='poly',degree=2).fit(i4train, o4trainClass)  
...
for i in range(nObsTest):
    if (L1[i]==o4testClass[i][0]):
        linear_true_pos+=1
    else:
        linear_false_pos+=1
    if (L2[i]==o4testClass[i][0]):
        rbf_true_pos+=1
    else:
        rbf_false_pos+=1
    if (L3[i]==o4testClass[i][0]):
        poly_true_pos+=1
    else:
        poly_false_pos+=1
    ...
    print('Obs: {:2} ({:<8}): Kernel Linear->{:<10} | Kernel RBF->{:<10} | Kernel Poly->{:<10}'.format(i,Classes[o4testClass[i][0]],Classes[L1[i]],Classes[L2[i]],Classes[L3[i]]))
...
i5train=np.vstack((trainFeatures_files,trainFeatures_browsing,trainFeatures_images,trainFeatures_streaming))
i5Ctest=np.vstack((testFeatures_files,testFeatures_browsing,testFeatures_images,testFeatures_streaming))
...
for i in range(nObsTest):
    if (LT[i]==o4testClass[i][0]):
        ml_true_pos+=1
    else:
        ml_false_pos+=1

    #detailed
    if (LT[i]==o4testClass[i][0] and o4testClass[i][0] == 0):
        ml_true_pos_files+=1
    elif (LT[i]!=o4testClass[i][0] and o4testClass[i][0] == 0):
        ml_false_pos_files+=1
    if (LT[i]==o4testClass[i][0] and o4testClass[i][0] == 1):
        ml_true_pos_browsing+=1
    elif (LT[i]!=o4testClass[i][0] and o4testClass[i][0] == 1):
        ml_false_pos_browsing+=1
    if (LT[i]==o4testClass[i][0] and o4testClass[i][0] == 2):
        ml_true_pos_images+=1
    elif (LT[i]!=o4testClass[i][0] and o4testClass[i][0] == 2):
        ml_false_pos_images+=1
    if (LT[i]==o4testClass[i][0] and o4testClass[i][0] == 3):
        ml_true_pos_streaming+=1
    elif (LT[i]!=o4testClass[i][0] and o4testClass[i][0] == 3):
        ml_false_pos_streaming+=1
    if (LT[i]==o4testClass[i][0] and o4testClass[i][0] == 4):
        ml_true_pos_rat+=1
    elif (LT[i]!=o4testClass[i][0] and o4testClass[i][0] == 4):
        ml_false_pos_rat+=1



    print('Obs: {:2} ({:<8}): Classification->{}'.format(i,Classes[o4testClass[i][0]],Classes[LT[i]]))
